export const locales = {
  en: {
    ...
    takenEmailOrUsername: "Username or email has alread taken",
  },
  fa: {
    // Login Page
    welcome: "خوش آمدید",
    signIn: "لطفاً وارد حساب کاربری خود شوید",
    email: "آدرس ایمیل",
    password: "کلمه عبور",
    ...
    passwordMinLength: "کلمه عبور باید حداقل ۸ کاراکتر باشد",
    ...
    takenEmailOrUsername: "نام کاربری یا ایمیل تکراری می باشد",
