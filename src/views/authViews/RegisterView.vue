<template>
  ...
  >
    <button
      ...
      class="absolute left-0 top-0 py-1.5 px-2.5 bg-blue-500 rounded-md m-2.5 text-white cursor-pointer hover:bg-blue-600 transition-colors"
    >
    ...
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="text-center">
        <div
          class="mx-auto h-12 w-12 bg-blue-500 rounded-xl flex items-center justify-center mb-6"
        >
          <svg
            width="24"
            height="24"
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              <label
                ...
                :class="{ 'text-right': currentLanguage === 'fa' }"
              >
              ...
              <div class="relative">
                <div
                  ...
                  :class="
                    currentLanguage === 'fa' ? 'right-0 pr-3' : 'left-0 pl-3'
                  "
                >
                  <svg
                    width="16"
          ...
          <div>
            ...
            <div class="relative">
              ...
              <button
                ...
                :class="
                  currentLanguage === 'fa' ? 'left-0 pl-3' : 'right-0 pr-3'
                "
              >
                <svg
                  v-if="showPassword"
          ...
          >
            <input
              ...
              :class="[
                ...
                {
                  'ml-2': currentLanguage === 'fa',
                  'mr-2': currentLanguage === 'en',
                },
              ]"
            />
            <label
              ...
              :class="{
                'mr-2': currentLanguage === 'fa',
                'ml-2': currentLanguage === 'en',
              }"
            >
          ...
          <div>
            <div class="relative">
              ...
              <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-white text-gray-500">{{
                  locales[currentLanguage].orContinue
                }}</span>
              </div>
            </div>
            ...
            <div class="mt-6 grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span class="ml-2">{{ locales[currentLanguage].google }}</span>
              </button>
              ...
              >
                ...
                <span class="ml-2">{{ locales[currentLanguage].github }}</span>
              </button>
            </div>
          </div>
        </form>
...
const validateForm = (): boolean => {
  ...
  if (!formData.confirmPassword) {
    newErrors.confirmPassword =
      locales[currentLanguage.value].confirmPasswordRequired;
  ...
  try {
    ...
    if (response.status >= 200 && response.status < 300) {
      notificationStore.showSuccess(
        locales[currentLanguage.value].registerSuccess,
      );
    ...
    if (error.response) {
        ...
        if (errorData) {
          ...
          if (errorData.username) {
            notificationStore.showError(
              locales[currentLanguage.value].usedUsername,
            );
          } else if (errorData.email) {
            // Show the specific email error or a generic message
            notificationStore.showError(
              errorData.email[0] || locales[currentLanguage.value].emailInvalid,
            );
          } else {
      ...
      notificationStore.showError(locales[currentLanguage.value].networkError);
    } else {
