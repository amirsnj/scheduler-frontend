<template>
  <li
    class="flex items-center px-2 py-2 rounded-lg transition-all text-gray-500 hover:bg-gray-100 hover:text-gray-700"
    :class="{
  ...
  >
    ...
    <!-- Edit Mode -->
    <div v-if="isEditMode" class="flex-1 flex items-center">
      <input
        ref="inputRef"
        v-model="editTitle"
        class="flex-1 text-sm font-medium bg-white border border-gray-300 rounded py-1 outline-none focus:border-blue-500"
