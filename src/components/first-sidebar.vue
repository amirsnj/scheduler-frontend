  ...
  <div>
    ...
    >
        ...
        <ul class="space-y-0.5">
          ...
          >
            ...
            <span
              class="text-xs font-medium"
              :class="
                activeItem === 'today' ? 'text-blue-600' : 'text-gray-400'
              "
              >{{ todayCount }}</span
            >
          </li>
          ...
          <li
            class="flex items-center px-3 py-2 rounded-lg cursor-pointer transition-all text-gray-500 hover:bg-gray-100 hover:text-gray-700"
            :class="{
              'bg-blue-50 text-blue-600': activeItem === 'sticky-wall',
            }"
      ...
      <div class="mb-8">
        ...
        <ul class="space-y-0.5">
          ...
          >
            ...
            <span
              class="text-xs font-medium"
              :class="
                activeItem === list.id ? 'text-blue-600' : 'text-gray-400'
              "
              >{{ list.count }}</span
            >
          </li>
        ...
        <div
          v-else
          class="mt-1 p-2 bg-gray-50 rounded-lg border border-gray-200"
        >
          <div class="flex items-center gap-2">
            ...
            <div class="flex items-center gap-1">
              <button
                ...
                :class="{
                  'opacity-50 cursor-not-allowed': !newListName.trim(),
                }"
              >
                <svg
                  width="14"
...
const confirmNewTag = (): void => {
  if (newTagName.value.trim()) {
    ...
    const randomColorSet =
      availableTagColors[Math.floor(Math.random() * availableTagColors.length)];
